...
def get_sheet_title(file_path, page_number):
    try:
...
def main():
    ...
    parser.add_argument("-p", "--page_number", type=int, required=True, help="Page number to search")
    parser.add_argument("-f", "--file", type=str, required=True, help="Path to the schematic XML file")

    args = parser.parse_args()
    get_sheet_title(args.file, args.page_number)
